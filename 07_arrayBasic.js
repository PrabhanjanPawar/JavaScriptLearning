...
console.log(`Value at 4th position is : ${arrayOfNumbers[4]}`);
console.log(`Replacing value of 4th positon by 12 : ${arrayOfNumbers[4]=12}`);
console.log((arrayOfNumbers));

const pos=arrayOfNumbers.indexOf(4);
console.log(pos);
