console.log("This is String Template Assignment : 02");
console.log("***************************************\n");
...
stringHandsOn =function (){
    ...
    // var lengthAfterSpaceRemove=removeSpace.length;
    // console.log(lengthAfterSpaceRemove);
    ...
    console.log(`8.2)  Substring strating from Index 22 using slice is : `, string.slice(22),"\n");
